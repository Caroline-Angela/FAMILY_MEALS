...
Menu.create!(calendar: calendar1, recipe: recipe2, date: Date.today, participants: 4, cook_name: "Paul", menu_style: 1)
Menu.create!(calendar: calendar1, recipe: recipe3, date: Date.today + 1, participants: 4, cook_name: "Peter", menu_style: 1)
Menu.create!(calendar: calendar1, recipe: recipe5, date: Date.today + 2, participants: 4, cook_name: "Lucas", menu_style: 1)
Menu.create!(calendar: calendar1, recipe: recipe7, date: Date.today + 4, participants: 4, cook_name: "Paul", menu_style: 1)
